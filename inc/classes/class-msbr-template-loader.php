 ...
 *
 * @package   MSBR_Template_Loader
 * @author    Gary Jones
 * @link      http://github.com/GaryJones/MSBR-Template-Loader
 * @copyright 2013 Gary Jones
 * @license   GPL-2.0-or-later
 * @version   1.3.1
 */

if ( ! class_exists( 'MSBR_Template_Loader' ) ) {
	...
	class MSBR_Template_Loader {
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'breview';
		 ...
		 * @var string
		 */
		protected $plugin_directory = MSBR_DIR;
